...
parser.add_argument('--experiment',default='',type=str,required=True,choices=['mnist4','mnist5','mnist2','pmnist','cifar','cifar5','mixture','cub5','fashion5','cifar5_100'],help='(default=%(default)s)')
...
count=0
if args.output=='':
    args.output='../res/'+args.experiment+'_'+args.approach+'_'+str(args.nepochs)+'_'+str(args.lr)+'_'+str(count)+'.txt'
    count+=1
print('='*100)
print('Arguments =')
...
elif args.experiment=='cub5':
    from dataloaders import cub5 as dataloader
elif args.experiment=='stl5':
    from dataloaders import stl5 as dataloader
elif args.experiment=='fashion5':
    from dataloaders import fashion5 as dataloader
elif args.experiment=='cifar5_100':
    from dataloaders import cifar5_100 as dataloader
elif args.experiment=='mnist4':
    from dataloaders import mnist4 as dataloader
...
for t,ncla in taskcla:
    ...
    #print('xvalid: {}'.format(xvalid))
    #print('yvalid: {}'.format(yvalid))
